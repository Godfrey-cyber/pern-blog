      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {blogs.map((item) => (
          <div key={item.id} className={`${
            ...
            <div className="h-48 group bg-gradient-to-br from-purple-400 to-blue-500 flex items-center justify-center">
              <img src={item.image} className="h-full w-full object-fit group-hover:opacity-50 opacity-100" />
            </div>
            <div className="p-4">
