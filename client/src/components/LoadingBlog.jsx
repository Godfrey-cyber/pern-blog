...
const LoadingBlog = () => {
	...
	return (
		<div className="flex flex-col w-full h-screen items-center justify-center">
			<p className="text-center font-bold text-green-700">There are no Blogs</p>
			<button
				onClick={() => navigate('/')}
				...
				>
					<MdOutlineChevronLeft className="h-5 w-5 text-gray-50 group-hover:text-green-600 transition-all delay-300" /> Back
			</button>
		</div>
	)
}
